...
public class TransController1007 {

    @RequestMapping(value = "/show1007")
    public String show1001(ModelMap map) {

        return "callcenter/trans1007";
    }
     ...
     * papers 证件号后四位
     */
    @RequestMapping(value = "/trans1007")
    @ResponseBody
    public Map<String, Object> trans1007(String phone,String papers) {
