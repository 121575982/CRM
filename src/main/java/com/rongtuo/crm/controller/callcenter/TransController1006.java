...
public class TransController1006 {

    @RequestMapping(value = "/show1006")
    public String show1006(ModelMap map) {

        return "callcenter/trans1006";
    }
     ...
     * papers 证件号后四位
     */
    @RequestMapping(value = "/trans1006")
    @ResponseBody
    public Map<String, Object> trans1006(String phone,String papers) {
