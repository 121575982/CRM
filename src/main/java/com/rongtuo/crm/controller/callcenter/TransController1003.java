...
public class TransController1003 {

    @RequestMapping(value = "/show1003")
    public String show1003(ModelMap map) {

        return "callcenter/trans1003";
    }
     ...
     * papers 证件号后四位
     */
    @RequestMapping(value = "/trans1003")
    @ResponseBody
    public Map<String, Object> trans1003(String phone,String papers) {
