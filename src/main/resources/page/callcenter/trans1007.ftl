...
<div class="panel panel-info">
    <div class="panel-heading">
        <span class="panel-title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;优惠券</span>
    ...
    <div class="panel-body collapse in">
        <table id="telrecord-grid"
            ...
            <tr>
                ...
                <th data-field="insertTime" data-sortable="true">来源</th>
                <th data-field="customerName" data-sortable="true">类型</th>
                <th data-field="customerSex" data-formatter="sexFormatter">数字</th>
                <th data-field="customerTel" data-sortable="true">有效期</th>
                <th data-field="customerTel" data-sortable="true">内容</th>
                <th data-field="customerTel" data-sortable="true">使用情况</th>
            </tr>
            </thead>
        </table>
    </div>
