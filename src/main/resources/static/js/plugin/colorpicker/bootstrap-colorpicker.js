...
define(function (require, exports, module) {
    ...
    (function ($) {
        ...
        var Colorpicker = function (element, options) {
            ...
            this.picker.appendTo(this.container ? this.container : $('#colorPanel'));
        ...
        Colorpicker.prototype = {
            ...
            reposition: function () {
                ...
                var offset = $(".my-colorpicker").offset();
                var left = $("#li1").width() + $("#li2").width() + $("#li3").width() / 2;

                this.picker.css({
                    top: $("#li3").height() / 2 + (this.component ? this.component.outerHeight() : this.element.outerHeight()),
                    left: left
                });
            },
            show: function (e) {
            ...
            mousemove: function (e) {
                ...
                this.update(true);
                chat.changeFontColor(this.color);
                this.element.trigger({
                    type: 'changeColor',
                    color: this.color
                });
