(function(){
    ...
    $(document).on("click", "li.thumb-item", function(){
        ...
        if(!$playerArea.length) 
        {
            ...
            //  顶部控制栏
            $('<p class="ctrl-box">' +
                 '<a class="hide-up"><i class="fa fa-upload"></i>&nbsp;收起</a>' +
                 '<a class="turn-left"><i class="fa fa-undo"></i>&nbsp;向左转</a>' +
                 '<a class="turn-right"><i class="fa fa-repeat"></i>&nbsp;向右转</a>' +
            ...
            $('<div class="display-area">' +
                  ...
                  '<i class="fa fa-chevron-circle-left go-left"></i>' +
                  '<i class="fa fa-chevron-circle-right go-right"></i></i>' +
